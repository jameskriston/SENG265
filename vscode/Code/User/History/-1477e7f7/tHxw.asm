...
main:       nop
        ...
        beq division_by_0       @ branch to division_by_0 if true

        ldr     r3, = quotient  @ address of result into r3
        ldr     r4, = remainder
...
loop:
     cmp r5, r1                 @ compare values of r0 and r1 (our index and b)
     bcc    valid_divison       @ if our index is less than b we are done
...
division_by_0: @stop program without doing anything for division by 0 (undefined)
